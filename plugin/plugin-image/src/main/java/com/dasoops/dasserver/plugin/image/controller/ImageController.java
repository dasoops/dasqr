...
public class ImageController {
    ...
    public PageResult<GetImageVo> getConfigPage(GetImageInfoPageParam param) {
        IPage<GetImageVo> imageDoPage = imageService.getImagePageData(param);
    ...
    public Result<GetFantastyUserVo> getConfigPage(GetFantastyUserParam param) {
    ...
    public SimpleResult addConfig(@RequestBody AddImageParam param) {
