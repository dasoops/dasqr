...
include(
    ...
    ":plugin:plugin-system:plugin-system-http-server",
    ":plugin:plugin-system:plugin-system-db-ktorm",
    ":plugin:plugin-loaj:plugin-alas",
    ":plugin:plugin-loaj:plugin-reply",
    ":plugin:plugin-loaj:plugin-ylynews",
    ":plugin:plugin-loaj:plugin-image-core",
    ":plugin:plugin-loaj:plugin-image-tencent-cos",
