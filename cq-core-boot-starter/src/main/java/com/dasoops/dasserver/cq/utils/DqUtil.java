...
public class DqUtil {
     ...
     */
    public static List<String> getParamStr(String message, String prefix, String separator, boolean ignoreDbc, boolean skipCq, boolean ignorePrefixSpace) {
